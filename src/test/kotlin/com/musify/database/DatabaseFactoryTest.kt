...
class DatabaseFactoryTest {
    ...
    fun `dbQuery should execute coroutine transactions`() = runBlocking {
        ...
        val result = DatabaseFactory.dbQuery {
            ...
            Users.selectAll().count() // Return count to indicate success
        }
    ...
    fun `should create tables with correct relationships`() {
        ...
        transaction {
            // First create a user for the artist
            val userId = Users.insertAndGetId {
                it[email] = "artist@example.com"
                it[username] = "artistuser"
                it[passwordHash] = "hashed"
                it[displayName] = "Artist User"
                it[isPremium] = false
