...
class GetFollowingUseCase(
    ...
    suspend fun execute(request: GetFollowingRequest): Flow<Result<List<User>>> = flow {
        ...
        when (val result = userFollowRepository.getFollowing(request.userId, request.limit, request.offset)) {
            is Result.Error -> {
